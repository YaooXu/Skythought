...
class Qwen2MLP(nn.Module):
    ...
    def __init__(
        ...
        # v3
        self.shift_weight = RowParallelLinear(
            3584*2,
            1,
            bias=False,
            quant_config=quant_config,
        ...
        self.gate_a = RowParallelLinear(
            hidden_size,
            64,
            bias=False,
            quant_config=quant_config,
            prefix=f"{prefix}.gate_a",
        )
        self.gate_b = RowParallelLinear(
            64,
            intermediate_size,
            bias=False,
            quant_config=quant_config,
            prefix=f"{prefix}.gate_b",
        )
    ...
    def forward(self, x):
        ...
        shift_gate = (self.gate_b(self.gate_a(x_shift)[0])[0] + self.gate_proj(x_shift)[0]) * score
