...
train_configs=(
    # "configs/train_lora/qwen2-7b_lora_sft-math-code-long_cot-64.yaml|saves/Bespoke-Stratos-17k/Qwen2.5-7B-Instruct/lora-64/complete_ckpt"
    "configs/train_full/qwen2-7b_full_sft-bs17k.yaml|saves/Bespoke-Stratos-17k/Qwen2.5-7B-Instruct/full"
)
...
for config_pair in "${train_configs[@]}"; do
    ...
    for task in "${tasks[@]}"; do
        ...
        skythought evaluate \
            ...
            --sampling-params temperature=0.7,max_tokens=16384 --n 32 \
