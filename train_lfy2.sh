...
# base model
train_configs=(
    # "configs/train_lora_lfy/qwen2-7b_lora_sft_math_long_cot_114k-296.yaml" # done
)
...
train_configs=(
    "configs/train_lora_lfy/qwen2-7b_lora_sft_math_long_cot_114k-256-shift_gate.yaml|256"
)
